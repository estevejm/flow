...
class SplitterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function mapDataProvider()
    {
        ...
        $subscriber1->publishes($command2);
        ...
        $handler3->publishes($event2)->publishes($event3);
        $handler4 = new Handler('handler_4');
        $handler4->publishes($event3);
        ...
        $subscriber2->publishes($event4)->publishes($event5);
        ...
        $subscriber4->publishes($command5);
        $event6 = new Event('event_6');
        $subscriber4->publishes($event6);
        $subscriber5->publishes($event6);
        ...
        $subscriber6->publishes($command6)->publishes($command7);
        $subscriber7 = new Subscriber('subscriber_7');
        $subscriber7->publishes($command7);
